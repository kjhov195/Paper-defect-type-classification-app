...
from sample import utils_model
...
class Model():
    ...
    def __init__(self, name='resnet50', checkpoint_model='',nb_classes=19):
        self.model = utils_model.create_model(name_model=name, num_classes=nb_classes)
        # self.model = utils_model.create_model(name, 19)
...
def main(args):
    ...
    model = utils_model.create_model(args.model,args.nb_classes)
